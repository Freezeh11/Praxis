...
/**
 * Validates a Boolean expression string for the parser's supported syntax.
 * Used by the sandbox random generator to guard round-trips and by any
 * future free-text entry point.
 *
 * @param {string} str
