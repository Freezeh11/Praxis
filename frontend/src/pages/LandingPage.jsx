      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 z-10 -mt-10">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-lg md:text-xl text-text-3 font-medium max-w-xl mb-10 leading-relaxed">
            Work through Boolean expressions step by step, apply algebraic laws, and verify equivalent forms in a focused interactive workspace.
          </motion.p>
        ...
        >
          {[
            { icon: 'W', title: 'Interactive Problems', desc: 'Work through expression simplification one step at a time.' },
            { icon: 'V', title: 'Law Validation', desc: 'Check whether the selected transformation is valid for the current expression.' },
            { icon: 'P', title: 'Progress Tracking', desc: 'See completed stages and continue where you left off.' }
          ].map((feat, i) => (
